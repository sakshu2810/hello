    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, null=True, upload_to='images/', validators=[comp2.models.validate_image, django.core.validators.FileExtensionValidator(allowed_extensions=['jpeg', 'jpg', 'pdf'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, null=True, upload_to='images/', validators=[comp2.models.validate_image, django.core.validators.FileExtensionValidator(allowed_extensions=['jpeg', 'jpg', 'pdf'])])),
                ('video_url', models.URLField(max_length=300)),
                ('c_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comp2.company')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
